...
import ArrowRightIcon from "../../assets/images/slide-arrow-right.svg";
import ArrowLeftIcon from "../../assets/images/slide-arrow-left.svg";
...
const CarouselItem = React.forwardRef(({ className, ...props }, ref) => {
    ...
    return <div ref={ref} role="group" aria-roledescription="slide" className={clsx(styles.carouselItem, orientation === "horizontal" ? styles.carouselItemHorizontal : styles.carouselItemVertical, className)} {...props} />;
});
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        {...props}
      >
        <ArrowRightIcon className={styles.carouselBtnIcon} />
      </button>
    );
  },
);
