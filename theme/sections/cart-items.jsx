...
import styles from "../styles/sections/cart-items.less";
  ...
  return (
    <div className="basePageContainer margin0auto">
      <div className={styles.cartMainContainer}>
                  ...
                  return (
                    <div className={styles.cartItemDetailsContainer}>
                      <div className={styles.cartTitleContainer}>
                        ...
                        {!!block?.props?.show_share_bag?.value && (
        ...
        {props?.show_sticky_footer?.value && (
          <StickyFooter
...
export const settings = {
  ...
  blocks: [
    ...
    {
      type: "share_cart",
      name: "Share Cart (Desktop)",
      props: [],
      info: "This will appear only on desktop view.",
    },
  ],
  preset: {
    blocks: [
